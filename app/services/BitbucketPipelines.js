...
module.exports = function () {
    var self = this,
        makeUrl = function () {
            return 'https://api.bitbucket.org/2.0/repositories/' + self.configuration.owner + '/' + self.configuration.slug + '/pipelines/?sort=-created_on&pagelen=1';
        },
        makeBasicAuthToken = function() {
           return Buffer.from(self.configuration.appPasswordUsername + ':' + self.configuration.appPassword).toString('base64');
        },
